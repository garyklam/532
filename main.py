...
if __name__ == '__main__':
    ...
    mqtt_connection = mqtt_connection_builder.mtls_from_path(
            ...
            cert_filepath="C:/Users/garyk/certs/device.pem.crt",
            pri_key_filepath="C:/Users/garyk/certs/private.pem.key",
            client_bootstrap=client_bootstrap,
            ca_filepath="C:/Users/garyk/certs/AmazonRootCA1.pem",
    ...
    for i in range(1, 120):
        ...
        while (curr-start).total_seconds() < 30:
            ...
            curr = datetime.now()
        message = {'count': f'{i}', 'time': f'{curr.month}/{curr.day} {curr.hour}:{curr.minute}:{curr.second}', 'blinks': TOTAL}
